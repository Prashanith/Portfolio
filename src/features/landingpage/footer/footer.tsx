function Footer() {
  return (
    <footer
      id="footer"
      className="relative py-12 flex flex-col items-center bg-primary overflow-hidden md:py-20"
    >
          ...
          <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
            <div className="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
              ...
              <ul className="list-disc list-inside space-y-8">
                <li>
                  <a href="#about" className="hover:text-sky-400 transition text-white">
                    About
                  </a>
                </li>

                <li>
                  <a href="#contact" className="hover:text-sky-400 transition text-white">
                    Contact
                  </a>
                </li>
              </ul>
              ...
              <ul role="list" className="space-y-8">
                ...
                <li>
                  <a
                    href="https://twitter.com/007prashanith"
                    target="_blank"
                    className="flex items-center space-x-3 hover:text-sky-400 transition"
                  >
                    <svg
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="hover:text-sky-400 text-white">
                      LinkedIn
                    </span>
                  </a>
                </li>
