...
function SkillCard({ skill, logo }: Skill) {
  return (
    <motion.div
      ...
      className="my-10 relative carousel-item flex flex-col items-center justify-center h-28 sm:h-32 md:h-36 lg:h-40 xl:h-44 2xl:h-48 aspect-square shadow-sm p-8 bg-primary/50 border-tertiary border-[1pt] rounded-lg"
    >
