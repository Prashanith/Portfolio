...
function SkillCard({ skill, logo }: Skill) {
  return (
    <motion.div
      ...
      className='carousel-item relative my-10 flex aspect-square h-28 flex-col items-center justify-center rounded-lg border-[1pt]
       glass-card p-8 shadow-sm transition-all duration-150 hover:scale-105 hover:shadow-tertiary 
